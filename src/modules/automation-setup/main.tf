...
resource "google_iam_workload_identity_pool_provider" "github_provider" {
  ...
  attribute_condition                = format("assertion.repository == 'Arrow-air/%s'", var.repo_name)
  attribute_mapping = {
    ...
    "github-actions" = {
      roles = {
        "iam.workloadIdentityUser" = {
          members = {
            format("//iam.googleapis.com/%s/attribute.repository/Arrow-air/%s", var.workload_identity_pool_name, var.repo_name) = "principalSet"
          }
        }
      }
    }
